describe('breadcrumbs', function() {
  it(optional('should record an XMLHttpRequest with a handler', IS_LOADER), function(done) {
  ...
  it(optional('should record an XMLHttpRequest without any handlers set', IS_LOADER), function(done) {
    var iframe = this.iframe;
  ...
  it(
    optional('should transform XMLHttpRequests to the Sentry store endpoint as sentry type breadcrumb', IS_LOADER),
    function(done) {
      var iframe = this.iframe;
      iframeExecute(
        iframe,
  ...
  it(optional('should flush keypress breadcrumbs when an error is thrown', IS_LOADER), function(done) {
    var iframe = this.iframe;
    iframeExecute(
      iframe,
      done,
  ...
  it(optional('should record history.[pushState|replaceState] changes as navigation breadcrumbs', IS_LOADER), function(
    done,
  ) {
    var iframe = this.iframe;
    ...
    iframeExecute(
      ...
      function(sentryData) {
        ...
        assert.ok(/\/variants\/.*\.html$/.test(breadcrumbs[0].data.from), "'from' url is incorrect");
  ...
  it(optional('should preserve native code detection compatibility', IS_LOADER), function(done) {
    var iframe = this.iframe;
